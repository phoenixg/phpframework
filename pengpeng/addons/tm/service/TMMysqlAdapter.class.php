...
class TMMysqlAdapter
{
    ...
    {
        if ($_SERVER['SERVER_TYPE'] == "production" || $_SERVER['SERVER_TYPE'] == "beta")
        {
          $cryption = new TMCryption();
          $dbpasswd = $cryption->decryption($dbpasswd);
        }
        ...
        if (! $this->connection)
        {
            throw new TMMysqlException("Can't connect the database ".$database." in ".$dbuser."@".$dbhost."used password ".$dbpasswd." ".mysqli_connect_error($this->connection));
        }
